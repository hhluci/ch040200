...
import com.bee.sample.pojo.Book;
@Controller
public class ThymeleafController {
	...
	public String regexptest(
		...
		// 保存数据到request作用范围域当中
		request.setAttribute("book", "Java图书");
		// 保存数据到session作用范围域当中
		session.setAttribute("school", "中北大学");
	...
	public String iftest(WebRequest webRequest){
		...
		webRequest.setAttribute("username", "wangwu", RequestAttributes.SCOPE_REQUEST);
